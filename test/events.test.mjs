...
test("builds posthog ai generation properties", () => {
  ...
  assert.deepEqual(properties.$ai_output_choices, [{ content: "Hello", role: "assistant" }]);
  assert.deepEqual(properties.$ai_input, [{ role: "user", content: "Hi", authorization: "[Redacted]" }]);
